...
?>
    ...
    <thead>
      ...
      <tbody>
        ...
        ?>
          <tr>
            <td><?php echo ucfirst($ligne["idclient"]) ?></td>
            <td><?php echo ucfirst($ligne["nom"]) ?></td>
            <td><?php echo ucfirst($ligne["prenom"]) ?></td>
            <td><?php echo ucfirst($ligne["ville"]) ?></td>
            <td><?php echo ucfirst($ligne["telephone"]) ?></td>
            <td>
            ...
            <div class="modal-dialog">
              <div class="modal-content rounded-3 shadow">
                <div class="modal-body p-4 text-center">
                  <h5 class="modal-title">Suprimer un client?</h5>
                  <p class="mb-0">Vous pouvez changer la donne en cliquant sur Annuler.</p>
                </div>
                <div class="modal-footer flex-nowrap p-0">
                  <a href="delete.php?id=<?php echo $ligne["idclient"]; ?>" class="btn btn-lg btn-link fs-6 text-decoration-none text-danger col-6 py-3 m-0 rounded-0 border-end"><strong>Oui, Suprimer</strong></a>
