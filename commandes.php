...
?>
    ...
    <thead>
      ...
      <tbody>
        ...
        ?>
          <tr>
            <td><?php echo ucfirst($ligne["idcommande"]) ?></td>
            <td><?php echo ucfirst($ligne["idclient"]) ?></td>
            <td><?php echo ucfirst($ligne["date"]) ?></td>
            <td>
            ...
            <div class="modal-dialog">
              <div class="modal-content rounded-3 shadow">
                <div class="modal-body p-4 text-center">
                  <h5 class="modal-title">Suprimer une commande?</h5>
                  <p class="mb-0">Vous pouvez changer la donne en cliquant sur Annuler.</p>
                </div>
                <div class="modal-footer flex-nowrap p-0">
                  <a href="delete.php?idcmd=<?php echo $ligne["idcommande"]; ?>" class="btn btn-lg btn-link fs-6 text-decoration-none text-danger col-6 py-3 m-0 rounded-0 border-end"><strong>Oui, Suprimer</strong></a>
